...
const slideButtonConfig = {
    Enterol: [
        ...
        { id: 'btn-home', icon: '/Farmacology/slides/Enterol2560/1icons/svg/home-door.svg', x: 10, y: 85, width: 5, height: 5, action: 'Reveal.slide(0);' },
        { id: 'btn-info', icon: '/Farmacology/slides/Enterol2560/1icons/svg/info.svg', x: 15, y: 85, width: 5, height: 5, action: 'Reveal.slide(0);' },
        { id: 'btn-settings', icon: '/Farmacology/slides/Enterol2560/1icons/svg/clip_path_group.svg', x: 20, y: 85, width: 5, height: 5, action: 'Reveal.slide(0);' },
        { id: 'btn-star', icon: '/Farmacology/slides/Enterol2560/1icons/svg/Shape.svg', x: 25, y: 85, width: 5, height: 5, action: 'Reveal.slide(0);' },
    ...
    Bebykol: [
        ...
        { id: 'btn-home', icon: '/Farmacology/slides/Bebykol2560/icons/323234.png', x: 10.8, y: 85, width: 5, height: 5, action: 'Reveal.slide(0);' },
        { id: 'btn-info', icon: '/Farmacology/slides/Bebykol2560/icons/14.png', x: 14.8, y: 85, width: 5, height: 5, action: 'Reveal.slide(0);' },
        { id: 'btn-settings', icon: '/Farmacology/slides/Bebykol2560/icons/Bebykol_2560_1600_2024.png', x: 18.8, y: 85, width: 5, height: 5, action: 'Reveal.slide(0);' },
    ],
    Stresam: [
        { id: 'btn-back', icon: '/Farmacology/slides/Bebykol2560/icons/545330_2024.png', x: 7, y: 85, width: 5, height: 5, action: 'Reveal.prev();' },
        { id: 'btn-star', icon: '/Farmacology/slides/Bebykol2560/icons/232324.png', x: 9.8, y: 85, width: 5, height: 5, action: 'Reveal.next();' },
        { id: 'btn-home', icon: '/Farmacology/slides/Bebykol2560/icons/323234.png', x: 13.8, y: 85, width: 5, height: 5, action: 'Reveal.slide(0);' },
        { id: 'btn-info', icon: '/Farmacology/slides/Bebykol2560/icons/14.png', x: 17.8, y: 85, width: 5, height: 5, action: 'Reveal.slide(0);' },
        { id: 'btn-settings', icon: '/Farmacology/slides/Bebykol2560/icons/Bebykol_2560_1600_2024.png', x: 21.8, y: 85, width: 5, height: 5, action: 'Reveal.slide(0);' },
    ],
};